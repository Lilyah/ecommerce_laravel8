                        ...
                        <form method="post" action="{{ route('category.store') }}">
                            ...
                            <div class="form-group">
					    		...
					    		<div class="controls">
                                    ...
                                    <small class="text-muted">Note: Use icons from <a href="https://fontawesome.com/search" target=”_blank”>https://fontawesome.com/search</a></small> <!-- target=”_blank” is to open the url in new browser tab -->
                                    @error('category_icon')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
