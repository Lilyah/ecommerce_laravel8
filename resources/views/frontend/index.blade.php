                ...
                <div class="item" style="background-image: url({{ asset($slider->slider_image) }});">
                  <div class="container-fluid">
                    <div class="caption bg-color vertical-center text-left">
                      ...
                      <div class="big-text fadeInDown-1">{{ (session()->get('language') == 'english') ? $slider->title_en : $slider->title_bg }}</div>
                      <div class="excerpt fadeInDown-2 hidden-xs"> <span>{{ (session()->get('language') == 'english') ? $slider->description_en : $slider->description_bg }}</span> </div>
                      <div class="button-holder fadeInDown-3"> <a href="index.php?page=single-product" class="btn-lg btn btn-uppercase btn-primary shop-now-button">{{ (session()->get('language') == 'english') ? 'Shop Now' : 'ПАЗАРУВАЙ СЕГА' }}</a> </div>
                    </div><!-- /.caption -->
                  </div><!-- /.container-fluid -->
                </div><!-- /.item -->
