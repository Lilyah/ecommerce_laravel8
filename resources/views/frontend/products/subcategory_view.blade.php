...
{{ (session()->get('language') == 'english') ?  $subcategory->subcategory_name_en .' - Ecommerce System' : $subcategory->subcategory_name_bg .' - Онлайн Магазин' }}
  ...
  <div class="container">
    <div class="breadcrumb-inner">
      <ul class="list-inline list-unstyled">
        ...
        <li class='active'>{{ (session()->get('language') == 'english') ? $subcategory->subcategory_name_en : $subcategory->subcategory_name_bg }}</li>
      </ul>
                                            ...
                                            <div class="accordion-group">
                                                ...
                                                <div class="accordion-heading"> 
                                                    <a href="#collapse{{ $category->id }}" data-toggle="collapse" class="accordion-toggle collapsed"> 
                                                        @if(session()->get('language') == 'bulgarian') {{ $category->category_name_bg }} @else {{ $category->category_name_en }} @endif 
                                                    </a> 
                                            ...
                                            <div class="products">
                                                ...
                                                <div class="product">
                                                    ...
                                                    <div class="product-info text-left">
                                                        <h3 class="name">
                                                            <a href="{{ url('product/details/'.$product->id.'/'.$product->product_slug_en ) }}">
                                                                {{ (session()->get('language') == 'bulgarian') ? $product->product_name_bg : $product->product_name_en }}
                                                            </a>
                                                        </h3>
                                                    ...
                                                    <div class="col col-sm-8 col-lg-8">
                                                        <div class="product-info">
                                                            <h3 class="name"><a href="{{ url('product/details/'.$product->id.'/'.$product->product_slug_en ) }}">
                                                                {{ (session()->get('language') == 'bulgarian') ? $product->product_name_bg : $product->product_name_en }} </a></h3>
                                                            ...
                                                            <div class="description m-t-10">
                                                                {{ (session()->get('language') == 'bulgarian') ? $product->short_descp_bg : $product->short_descp_en }}
                                                            </div>
