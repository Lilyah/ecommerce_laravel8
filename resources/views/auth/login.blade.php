...
<div class="col-md-6 col-sm-6 sign-in">
	...
	<div class="social-sign-in outer-top-xs">
		<a href="#" class="facebook-sign-in"><i class="fa-brands fa-facebook"></i> Sign In with Facebook</a>
		<a href="#" class="twitter-sign-in"><i class="fa-brands fa-twitter"></i> Sign In with Twitter</a>
	</div>
...
<div class="col-md-6 col-sm-6 create-new-account">
	...
	<form class="register-form outer-top-xs" role="form" method="POST" action="{{ route('register') }}">
        ...
        <div class="form-group">
		    <label class="info-title" for="exampnameleInputEmail1">Name <span>*</span></label>
